...
docker run -ti \
    ...
    -e repo_dir=$repo_dir \
    -e main=$repo_dir/linkage_disequilibrium/cov-ldsc/wdl_v1.1/cov_ldsc_whole_genome_wf/cov_ldsc_whole_genome_wf.wdl \
    -e name="cov-LDSC Workflow (Whole Genome)" \
    -e description="Workflow for calculating LD scores for the whole genome using cov-LDSC" \
    -e engine=WDL \

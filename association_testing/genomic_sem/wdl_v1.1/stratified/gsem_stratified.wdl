...
workflow gsem_stratified {
  input {
    ...
    String? munge_memory
    Int s_ldsc_cpu = 1
    String s_ldsc_memory = "8G"
    Int enrich_cpu = 1
    String enrich_memory = "8G"
}
  ...
  parameter_meta {
    ...
    s_ldsc_memory: "Requested memory for s_ldsc task runtime."
    enrich_cpu: "Requested CPU cores for enrich task runtime."
    enrich_memory: "Requested memory for enrich task runtime."
}
